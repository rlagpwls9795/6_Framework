...
<body>
	<main>
		...
		<section class="board-list">
			...
			<form action="#" method="get" id="boardSearch" onsubmit="return false">
				...
				</select> <input type="text" name="query" id="search-query" placeholder="검색어를 입력해주세요.">
	...
	<!-- 썸네일 클릭 시 모달창 출력 -->
	<div class="modal">
		<span id="modal-close">&times;</span> <img id="modal-image" src="/resources/images/board/20221116105843_00001.gif">
	</div>
