...
<header>
	<section>
		...
		<a href="/"> <img src="/resources/images/logo.jpg" id="home-logo">
		</a>
	</section>
	...
	<div id="header-top-Menu">
		<c:choose>
			...
			<%-- 로그인 O인 경우 --%>
			<c:otherwise>
				<label for="header-menu-toggle"> ${loginMember.memberNickname} <i class="fa-solid fa-caret-down"></i> <%-- fontawesome 아이콘 --%>
				</label>
				<input type="checkbox" id="header-menu-toggle">
				<div id="header-menu">
					<a href="/member/myPage/info">내정보</a> <a href="/member/logout">로그아웃</a>
				</div>
			</c:otherwise>
		</c:choose>
	</div>
