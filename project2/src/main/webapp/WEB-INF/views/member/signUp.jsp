            ...
            <form action="/member/signUp" method="POST" name="signUp-frm" id="signUp-frm">
                ...
                <div class="signUp-input-area">
                    <input type="text" name="memberEmail" id="memberEmail" placeholder="아이디(이메일)" 
                        maxlength="50" autocomplete="off" required value="${tempMember.memberEmail}">
                ...
                <span class="signUp-message" id="pwMessage">영어, 숫자, 특수문자(!,@,#,-,_) 6~10 글자 사이로 입력하세요.</span>
                ...
                <span class="signUp-message" id="nicknameMessage">한글,영어,숫자로만 2~10글자 사이로 입력하세요.</span>
